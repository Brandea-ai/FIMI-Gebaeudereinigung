...
export const branchen: Branche[] = [
  ...
  // ============================================
  {
    ...
    shortName: 'Büro',
    metaTitle: 'Reinigung für Kanzleien & Verwaltung Bayern | FIMI',
    metaDescription: 'Diskretion für sensible Bereiche: Banken, Kanzleien, Ämter. Reinigung außerhalb der Kernzeiten. Sicherheitsüberprüftes Personal. Konzept anfragen.',
    keywords: [
...
**Unzufrieden mit Ihrer aktuellen Reinigungsfirma?** Sie sind nicht allein. Viele unserer besten Kunden kamen zu uns, weil der vorherige Dienstleister unzuverlässig war. Bei FIMI ist das anders – seit 2016 setzen wir auf Qualität statt Quantität.
  ...
  // ============================================
  {
    ...
    shortName: 'Industrie',
    metaTitle: 'Reinigung für Produktion & Fertigung Bayern | FIMI',
    metaDescription: 'PSA-konform, Schichtbetrieb-flexibel: Industriereinigung für Dingolfing, Ingolstadt & Co. Wir kennen Ihre Sicherheitsstandards. Beratung gratis.',
    keywords: [
...
**Wir stellen uns auf Ihre Produktion ein – nicht umgekehrt.**
  ...
  // ============================================
  {
    ...
    metaTitle: 'Praxis- & Klinik-Reinigung Bayern - RKI-konform | FIMI',
    metaDescription: 'Hygiene nach RKI/KRINKO: Desinfektion für Arztpraxen, Pflegeheime, Kliniken. Dokumentiert & auditfest. Hygienekonzept anfragen.',
    keywords: [
...
**Ihre Patienten vertrauen Ihnen. Vertrauen Sie uns.**
  ...
  // ============================================
  {
    ...
    name: 'Einzelhandel',
    shortName: 'Handel',
    metaTitle: 'Reinigung für Shops & Läden Bayern | FIMI',
    metaDescription: 'Glänzende Böden vor Ladenöffnung: Reinigung ab 5 Uhr für Einzelhandel in Regensburg, Landshut & München. Saubere Regale, zufriedene Kunden.',
    keywords: [
...
**Ihr Geschäft verdient eine Reinigung, die zu Ihrem Qualitätsanspruch passt.**
  ...
  // ============================================
  {
    ...
    shortName: 'Gastro',
    metaTitle: 'Hotel- & Gastro-Reinigung Bayern - HACCP | FIMI',
    metaDescription: 'Sauberkeit für 5-Sterne-Bewertungen: HACCP-konforme Reinigung für Hotels, Restaurants, Großküchen. Zimmer, Lobby, Küche. Konzept anfordern.',
    keywords: [
...
**HACCP-Dokumentation auf Wunsch** – für Ihre Unterlagen und Kontrollen.
  ...
  // ============================================
  {
    ...
    shortName: 'Bildung',
    metaTitle: 'Schulreinigung Bayern - Partner für Kommunen | FIMI',
    metaDescription: 'Zuverlässig für Schulen & Kitas: Kosteneffizient für Träger, Grundreinigung in den Ferien. Hygieneplan inklusive. Angebot für Kommunen.',
    keywords: [
...
**Gesunde Kinder lernen besser.** Mit FIMI sorgen Sie für ein hygienisches Lernumfeld.
  ...
  // ============================================
  {
    ...
    name: 'Fitness & Sport',
    shortName: 'Fitness',
    metaTitle: 'Fitness-Studio Reinigung Bayern - Hygiene | FIMI',
    metaDescription: 'Schweiß & Bakterien keine Chance: Tägliche Desinfektion von Geräten, Umkleiden, Duschen. Sicheres Training für Ihre Mitglieder. Service anfragen.',
    keywords: [
...
**Saubere Studios binden Mitglieder.** Investieren Sie in Hygiene.
  ...
  // ============================================
  {
    ...
    name: 'Logistik & Lager',
    shortName: 'Logistik',
    metaTitle: 'Lager- & Logistik-Reinigung Bayern | FIMI',
    metaDescription: 'Freie Fahrt für Stapler: Reifenabrieb, Verpackungsmüll, Staub entfernt. Arbeitssicherheit durch Sauberkeit. Logistikzentren Bayern. Angebot holen.',
    keywords: [
...
**Wir reinigen, wenn Sie es brauchen – nicht wenn es uns passt.**
  ...
  // ============================================
  {
    ...
    shortName: 'Wohnen',
    metaTitle: 'Service für Hausverwaltungen Bayern - WEG | FIMI',
    metaDescription: 'Entlastung für Verwalter: Treppenhaus, Außenpflege, Winterdienst aus einer Hand. Werterhalt für Wohnanlagen. Landshut & Region. Paket anfragen.',
    keywords: [
...
**Weniger Mieterbeschwerden, weniger Stress für Sie.**
  ...
  // ============================================
  {
    ...
    metaTitle: 'Reinigung für Behörden & Ämter Bayern | FIMI',
    metaDescription: 'Partner der öffentlichen Hand: Rathäuser, Ämter, Behörden. Transparente Abrechnung, sicherheitsüberprüftes Personal. Ausschreibung begleiten.',
    keywords: [
...
**Wir verstehen öffentliche Auftraggeber – und liefern, was Sie brauchen.**
  ...
  // ============================================
  {
    ...
    shortName: 'Finanzen',
    metaTitle: 'Reinigung für Banken & Finanz Bayern | FIMI',
    metaDescription: 'Höchste Diskretion garantiert: Geschultes Stammpersonal für sensible Bereiche in Finanzinstituten. Sicherheit geht vor. Beratung vereinbaren.',
    keywords: [
...
**Ihr guter Ruf ist unser Auftrag.**
  ...
  // ============================================
  {
    ...
    name: 'Automotive',
    shortName: 'Auto',
    metaTitle: 'Autohaus- & Werkstatt-Reinigung Bayern | FIMI',
    metaDescription: 'Showroom-Glanz & Werkstatt-Sicherheit: Reinigung für Autohäuser von Fahrzeugpräsentation bis Hebebühne. Bayern. Konzept anfragen.',
    keywords: [
