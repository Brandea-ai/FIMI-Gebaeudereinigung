...
[Unterschrift]`;
    ...
    a.href = url;
    a.download = 'Löschantrag_FIMI_Gebäudereinigung_GmbH.txt';
...
[Unterschrift]`;
    ...
    const a = document.createElement('a');
    a.href = url;
    a.download = 'Widerruf_Einwilligung_FIMI_Gebäudereinigung_GmbH.txt';
    document.body.appendChild(a);
    a.click();
    document.body.removeChild(a);
    URL.revokeObjectURL(url);
          ...
          <div className="datenschutz-layout">
            ...
            <div className="datenschutz-content">
              ...
              <section id="hosting" className="section-tracked content-block" aria-labelledby="hosting-heading">
                ...
                <p className="text-body">Wir hosten die Inhalte unserer Website beim folgenden Anbieter:</p>
