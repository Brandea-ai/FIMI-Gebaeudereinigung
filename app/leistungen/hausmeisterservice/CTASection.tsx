...
import { ArrowRight, Phone, CheckCircle, Building2, Home, Briefcase, Factory, Landmark, Banknote } from 'lucide-react'

// Relevante Branchen für Hausmeisterservice
const branchen = [
  ...
  { slug: 'banken-versicherungen', name: 'Banken', icon: Banknote },
  { slug: 'logistik-lager', name: 'Logistik', icon: Briefcase },
]
        ...
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-16">
          ...
          <div>
            ...
            <h3 className="text-xl sm:text-2xl lg:text-3xl font-bold text-white mb-4 sm:mb-6">
              Hausmeisterservice für Ihre Branche
            </h3>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-2 sm:gap-3 lg:gap-4 mb-6 sm:mb-8">
              {branchen.map((branche) => {
                ...
                return (
                  ...
                  >
                    {/* Icon - Outlined Style */}
                    <div className="w-8 h-8 sm:w-9 sm:h-9 lg:w-10 lg:h-10 border-2 border-[#109387] group-hover:bg-[#109387] rounded-[6px] flex items-center justify-center flex-shrink-0 transition-all duration-300" aria-hidden="true">
          ...
          <div className="bg-white rounded-[6px] p-5 sm:p-6 lg:p-10">
            ...
            {/* Trust-Elemente */}
            <div className="space-y-2 sm:space-y-3" role="list" aria-label="Vorteile">
