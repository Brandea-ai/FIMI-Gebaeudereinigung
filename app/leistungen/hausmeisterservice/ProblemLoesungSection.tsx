...
import { ArrowRight, UserX, Clock, AlertTriangle, Wrench } from 'lucide-react'

const probleme = [
  {
    icon: UserX,
    problem: 'Ihr Hausmeister ist krank oder im Urlaub',
    loesung: 'Wir springen innerhalb von 2 Stunden ein – mit eigenem Team und Equipment. Kein Stillstand, keine Beschwerden.',
  },
  {
    icon: Clock,
    problem: 'Ihr bisheriger Hausmeister geht in Rente',
    loesung: 'Nahtlose Übernahme mit Übergabeprotokoll und festem Ansprechpartner. Kein Wissen geht verloren.',
  },
  {
    icon: AlertTriangle,
    problem: 'Die Qualität schwankt von Woche zu Woche',
    loesung: 'Dokumentierte Checklisten, regelmäßige Qualitätskontrollen durch unsere Objektleiter. Gleichbleibend gut.',
  },
  {
    icon: Wrench,
    problem: 'Kleinreparaturen bleiben ewig liegen',
    loesung: 'Alles aus einer Hand – von der Glühbirne bis zur Türdichtung. Defekte werden sofort behoben.',
  },
]
      ...
      <div className="w-full max-w-[1800px] mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-20">
        ...
        <div className="max-w-3xl mb-8 sm:mb-12 lg:mb-16">
          ...
          <p className="text-base sm:text-lg text-gray-600 font-semibold leading-relaxed">
            ...
            Ein zuverlässiger Hausmeister ist Gold wert. Wir lösen diese Probleme – täglich.
          </p>
        </div>
        ...
        <div className="mt-10 sm:mt-12 lg:mt-16 grid md:grid-cols-2 gap-6 sm:gap-8 items-center">
          ...
          <div className="md:pl-4 lg:pl-8">
            ...
            <p className="text-gray-600 font-semibold leading-relaxed mb-4 sm:mb-6 text-sm sm:text-base">
              Ob kurzfristige Vertretung oder langfristige Partnerschaft – wir sind da,
              wenn Sie uns brauchen. Ihre Mieter merken keinen Unterschied,
              außer dass alles reibungslos läuft.
            </p>
            <a
              href="#kontakt"
