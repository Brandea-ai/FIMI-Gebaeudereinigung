...
import { ArrowRight, Phone, CheckCircle, Factory, Sparkles, Layers, Building2 } from 'lucide-react'

// 4 verwandte Leistungen für Maschinenreinigung
const verwandteLeistungen = [
  { slug: 'industriereinigung', name: 'Industriereinigung', icon: Factory },
  { slug: 'hallenreinigung', name: 'Hallenreinigung', icon: Layers },
        ...
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-16">
          ...
          <div className="bg-white rounded-[6px] p-5 sm:p-6 lg:p-10">
            ...
            <p className="text-sm sm:text-base text-gray-600 font-semibold leading-relaxed mb-5 sm:mb-6">
              ...
              Wir reinigen Ihre Produktionsmaschinen professionell und zuverlässig.
            </p>
