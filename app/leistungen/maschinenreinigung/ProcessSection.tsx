...
const processSteps = [
  {
    ...
    icon: Phone,
    title: 'Anfrage',
    description: 'Sie rufen an oder nutzen das Kontaktformular. Wir melden uns innerhalb von 2 Stunden.',
    time: '5 Minuten',
  },
  {
    number: '02',
    icon: MapPin,
    title: 'Besichtigung',
    description: 'Wir kommen kostenfrei zu Ihnen und analysieren Ihre Maschinen vor Ort.',
    time: '1-2 Tage',
  },
  {
    number: '03',
  ...
  },
  {
    ...
    icon: Sparkles,
    title: 'Reinigung',
    description: 'Unsere Spezialisten reinigen Ihre Maschinen – auch nachts oder am Wochenende.',
      ...
      <div className="w-full max-w-[1800px] mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-20">
        ...
        <div className="text-center max-w-3xl mx-auto mb-8 sm:mb-12 lg:mb-16">
          ...
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-[#012956] leading-tight mb-4 sm:mb-6">
            In 4 Schritten zur sauberen Maschine
          </h2>
          <p className="text-base sm:text-lg text-gray-600 font-semibold leading-relaxed">
            Vom ersten Kontakt bis zur gereinigten Maschine – unkompliziert,
        ...
        >
          <p className="text-sm sm:text-base lg:text-lg text-gray-600 font-semibold">
            <strong className="text-[#012956]">Gesamtdauer:</strong> Von der Anfrage bis zur gereinigten Maschine vergehen durchschnittlich 3-5 Werktage.
          </p>
