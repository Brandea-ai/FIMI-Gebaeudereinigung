...
const branchen = [
  ...
  },
  {
    ...
    beschreibung: 'HACCP-konforme Reinigung von Verpackungsmaschinen, Abfüllanlagen und Produktionslinien.',
    beispiele: 'Molkereien, Fleischverarbeiter, Getränkehersteller',
    slug: 'lebensmittel',
    bild: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?q=80&w=600&auto=format&fit=crop',
  },
  {
    id: 'pharma',
    icon: Pill,
    name: 'Pharma & Medizintechnik',
    beschreibung: 'Reinraumtaugliche Reinigung unter GMP-Bedingungen. Dokumentation für Ihre Validierung.',
    beispiele: 'Pharma-Produktion, Labore, Medizinprodukte',
    slug: 'pharma-medizintechnik',
  ...
  },
  {
    ...
    beschreibung: 'Spritzgussmaschinen, Extruder, Blasformanlagen – Trockeneisreinigung für saubere Werkzeuge.',
    beispiele: 'Spritzgießer, Formenbauer, Kunststoffverarbeiter',
    slug: 'kunststoff',
    bild: 'https://images.unsplash.com/photo-1533417479674-e40666ce7fa5?q=80&w=600&auto=format&fit=crop',
  },
  {
    id: 'maschinenbau',
    icon: Cog,
    name: 'Maschinenbau',
    beschreibung: 'Werkzeugmaschinen, Sondermaschinen, Prüfstände – Reinigung nach Herstellervorgaben.',
    beispiele: 'Maschinenbauer, Anlagenbauer, OEMs',
    slug: 'maschinenbau',
    bild: 'https://images.unsplash.com/photo-1565193566173-7a0ee3dbe261?q=80&w=600&auto=format&fit=crop',
  },
]
