      ...
      <div className="w-full max-w-[1800px] mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-20">
        ...
        <div className="max-w-3xl mb-8 sm:mb-10 lg:mb-12">
          ...
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-[#012956] leading-tight mb-4 sm:mb-6">
            Maschinenreinigung in der Nähe
          </h2>
          <p className="text-base sm:text-lg text-gray-600 font-semibold leading-relaxed">
            Wir sind in ganz Bayern für Sie da. Kurze Wege bedeuten schnelle Reaktionszeiten
            und Teams, die Ihre Region kennen.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-6 sm:gap-8 lg:gap-12">
          ...
          <div className="flex flex-col justify-center">
            ...
            >
              Maschinenreinigung in {active.name} anfragen
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 sm:gap-6">
            <div>
              ...
              <p className="text-gray-600 font-semibold text-sm sm:text-base">
                Wir sind in ganz Bayern aktiv – von Passau bis Würzburg, von Kempten bis Hof.
              </p>
            </div>
