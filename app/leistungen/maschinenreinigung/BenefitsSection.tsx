    ...
    <section className="section-padding bg-white">
      <div className="container-custom">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="mb-6">Warum FIMI Maschinenreinigung?</h2>
          <p className="text-xl text-gray-600">
            Unsere Maschinenreinigung vereint Fachkompetenz, Sorgfalt und Präzision für optimale Produktionsbedingungen.
          </p>
        </div>
