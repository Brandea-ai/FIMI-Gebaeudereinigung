...
const blogArtikel = [
  {
    ...
    excerpt: 'Die Reinigung von Produktionsanlagen und Maschinen stellt hohe Anforderungen an die Arbeitssicherheit. Strikte Einhaltung der DGUV-Vorschriften und Gefahrstoffverordnung.',
  ...
  },
  {
    ...
    titel: 'Die richtigen Reinigungsintervalle: Wie oft muss gereinigt werden?',
    excerpt: 'Die Festlegung der richtigen Reinigungsintervalle ist entscheidend für Hygiene, Werterhalt und Kosteneffizienz. Bedarfsgerechte Planung nach DIN und RAL-Standards.',
    kategorie: 'Ratgeber',
    lesezeit: '4 Min.',
  ...
  },
  {
    ...
    titel: 'Hygiene am Arbeitsplatz: Aktuelle Standards für ein gesundes Büro',
    excerpt: 'Bewährte Schutzmaßnahmen definieren heute den Standard für ein gesundes Arbeitsumfeld. BMAS- und BAuA-Empfehlungen im Überblick.',
    kategorie: 'Hygiene',
    lesezeit: '4 Min.',
