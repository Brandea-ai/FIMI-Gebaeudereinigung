...
import { Calendar, Factory, Clock, Award } from 'lucide-react'
...
const stats = [
  {
    ...
    sublabel: 'in Hallenreinigung',
  },
  {
    icon: Factory,
    value: '500+',
    label: 'Hallen gereinigt',
    sublabel: 'Lager, Produktion, Logistik',
  },
  {
    icon: Clock,
    value: '2h',
    label: 'Reaktionszeit',
    sublabel: 'bei Notfällen',
  },
  {
    icon: Award,
    value: '100%',
    label: 'Zufriedenheit',
    sublabel: 'oder Nacharbeit',
  },
]
