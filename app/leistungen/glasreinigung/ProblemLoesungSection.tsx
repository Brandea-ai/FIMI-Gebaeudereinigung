...
const probleme = [
  {
    icon: Frown,
    problem: 'Nach der Reinigung bleiben Streifen und Schlieren auf dem Glas',
    loesung: 'Unsere Osmose-Technik nutzt mineralfreies Reinwasser – für garantiert streifenfreie Ergebnisse ohne Nachpolieren.',
  },
  {
    icon: UserX,
    problem: 'Der Reinigungsdienst kommt unzuverlässig oder verpasst Termine',
    loesung: 'Feste Termine, festes Team, fester Ansprechpartner. Sie wissen immer genau, wann gereinigt wird – und es passiert auch.',
  },
  {
    icon: Mountain,
    problem: 'Glasfassaden in großer Höhe sind schwer zu erreichen',
    loesung: 'Mit Teleskopstangen bis 18m, Hubsteigern und zertifizierten Industriekletterern erreichen wir jede Glasfläche sicher.',
  },
  {
    icon: Calculator,
    problem: 'Unklare Preise und versteckte Zusatzkosten',
    loesung: 'Nach kostenloser Besichtigung erhalten Sie einen transparenten Festpreis. Keine Überraschungen, keine versteckten Kosten.',
  },
]
      ...
      <div className="w-full max-w-[1800px] mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-20">
        ...
        <div className="max-w-3xl mb-8 sm:mb-12 lg:mb-16">
          ...
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-[#012956] leading-tight mb-4 sm:mb-6">
            Herausforderungen bei der Glasreinigung
          </h2>
          <p className="text-base sm:text-lg text-gray-600 font-semibold leading-relaxed">
            Glasfassaden stellen besondere Anforderungen: Höhe, Zugänglichkeit, streifenfreie Ergebnisse.
            Viele Unternehmen haben schlechte Erfahrungen gemacht. Das ändern wir.
          </p>
        </div>
        ...
        <div className="mt-10 sm:mt-12 lg:mt-16 grid md:grid-cols-2 gap-6 sm:gap-8 items-center">
          <div className="relative h-[220px] sm:h-[280px] md:h-[350px] lg:h-[400px] rounded-[6px] overflow-hidden">
            <Image
              ...
              alt="Moderne Glasfassade eines Bürogebäudes mit klarem Durchblick"
              fill
          ...
          <div className="md:pl-4 lg:pl-8">
            <h3 className="text-xl sm:text-2xl lg:text-3xl font-bold text-[#012956] mb-3 sm:mb-4">
              Ihre Glasfassade ist Ihre Visitenkarte
            </h3>
            <p className="text-gray-600 font-semibold leading-relaxed mb-4 sm:mb-6 text-sm sm:text-base">
              Kunden, Besucher und Mitarbeiter sehen Ihre Glasfassade jeden Tag.
              Eine gepflegte, streifenfreie Glasfront signalisiert Professionalität und Qualitätsanspruch.
              Wir sorgen dafür, dass dieser erste Eindruck stimmt – zuverlässig und dauerhaft.
            </p>
            <a
              href="#kontakt"
