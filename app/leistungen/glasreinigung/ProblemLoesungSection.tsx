...
import { ArrowRight, Droplets, CloudRain, Eye, Frown } from 'lucide-react'

const probleme = [
  {
    icon: Droplets,
    problem: 'Wasserflecken und Kalkablagerungen überall',
    loesung: 'Professionelle Reinigung mit speziellen Entkalkern und Mikrofasertechnik. Wir entfernen selbst hartnäckige Ablagerungen rückstandsfrei.',
  },
  {
    icon: CloudRain,
    problem: 'Nach dem Regen sieht alles schlimmer aus als vorher',
    loesung: 'Unsere streifenfreie Technik mit Abziehern und Osmosewasser sorgt dafür, dass Regen keine sichtbaren Spuren hinterlässt.',
  },
  {
    icon: Frown,
    problem: 'Die eigene Reinigung schafft nur Streifen und Schlieren',
    loesung: 'Professionelle Glasreinigung mit geschultem Personal, den richtigen Werkzeugen und bewährten Techniken – garantiert streifenfrei.',
  },
  {
    icon: Eye,
    problem: 'Kunden sehen schmutzige Schaufenster und gehen weiter',
    loesung: 'Kristallklare Schaufenster, die Ihre Produkte ins beste Licht rücken. Regelmäßige Reinigung für einen professionellen ersten Eindruck.',
  },
]
      ...
      <div className="w-full max-w-[1800px] mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-20">
        ...
        <div className="max-w-3xl mb-8 sm:mb-12 lg:mb-16">
          ...
          <p className="text-base sm:text-lg text-gray-600 font-semibold leading-relaxed">
            Schmutzige Fenster fallen auf – saubere nicht. Genau so soll es sein.
            Wir sorgen dafür, dass Ihre Glasflächen immer im besten Licht erstrahlen.
          </p>
        </div>
        ...
        <div className="mt-10 sm:mt-12 lg:mt-16 grid md:grid-cols-2 gap-6 sm:gap-8 items-center">
          <div className="relative h-[220px] sm:h-[280px] md:h-[350px] lg:h-[400px] rounded-[6px] overflow-hidden">
            <Image
              src="https://images.unsplash.com/photo-1596394723269-b2cbca4e6313?q=80&w=2000&auto=format&fit=crop"
              alt="Kristallklare Glasfassade nach professioneller Glasreinigung"
              fill
          ...
          <div className="md:pl-4 lg:pl-8">
            <h3 className="text-xl sm:text-2xl lg:text-3xl font-bold text-[#012956] mb-3 sm:mb-4">
              Fensterputzen ist nicht Ihr Job
            </h3>
            <p className="text-gray-600 font-semibold leading-relaxed mb-4 sm:mb-6 text-sm sm:text-base">
              Lassen Sie Glasreinigung Profis machen. Während Sie Ihr Unternehmen führen,
              sorgen wir für streifenfreie Fenster und Glasflächen – zuverlässig,
              sicher und mit Ergebnis-Garantie.
            </p>
            <a
              href="#kontakt"
