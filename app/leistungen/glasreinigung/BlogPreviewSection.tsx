...
// Thematisch passende Artikel für Glasreinigung
const relatedPosts = [
  {
  ...
  {
    slug: 'glasreinigung-tipps-gewerbe',
    title: 'Warum professionelle Glasreinigung sich für Ihr Geschäft lohnt',
    excerpt: 'Saubere Fenster sind mehr als Optik: Wie Glasreinigung Ihren Geschäftserfolg beeinflusst.',
  ...
  {
    slug: 'osmose-reinigung-erklaert',
    title: 'Osmose-Reinigung: Die umweltfreundliche Methode für Glasfassaden',
    excerpt: 'Wie funktioniert Reinigung mit entmineralisiertem Wasser – und warum ist sie so effektiv?',
    image: 'https://images.unsplash.com/photo-1596394723269-b2cbca4e6313?q=80&w=800&auto=format&fit=crop',
    category: 'Wissen',
    date: '2025-01-05',
    readTime: 5,
  },
        ...
        <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-4 sm:gap-6 mb-8 sm:mb-10 lg:mb-12">
          <div className="max-w-2xl">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-[#012956] leading-tight mb-3 sm:mb-4">
              Wissen rund um Glasreinigung
            </h2>
            <p className="text-sm sm:text-base lg:text-lg text-gray-600 font-semibold leading-relaxed">
              Aktuelle Branchennews, praktische Tipps und Einblicke in professionelle Glasreinigung.
            </p>
          </div>
