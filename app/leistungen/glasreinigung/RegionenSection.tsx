...
const regionen = [
  {
    ...
    beschreibung: 'Als Landshuter Unternehmen kennen wir die Stadt und ihre Gebäude. Ob Altstadt-Schaufenster, Bürofenster in Ergolding oder Glasfassaden im Gewerbegebiet – wir sind schnell vor Ort.',
  ...
  },
  {
    ...
    beschreibung: 'Professionelle Glasreinigung für die Landeshauptstadt. Vom Werksviertel bis Schwabing – moderne Glasfassaden und historische Schaufenster, wir reinigen alles streifenfrei.',
  ...
  },
  {
    ...
    beschreibung: 'Von der UNESCO-Altstadt bis zum Gewerbepark. Wir reinigen historische Fenster genauso sorgfältig wie moderne Glasfronten.',
  ...
  },
  {
    ...
    beschreibung: 'Der Automobilstandort verlangt Präzision. Glasfassaden von Zulieferern, Showrooms und Bürogebäude – wir arbeiten nach höchsten Standards.',
  ...
  },
  {
    ...
    beschreibung: 'Zwischen Flughafen und TU Weihenstephan. Wir reinigen Glasflächen in Büros, Forschungseinrichtungen und Gewerbeobjekten im gesamten Landkreis.',
  ...
  },
  {
    ...
    beschreibung: 'Für den wachsenden Landkreis. Gewerbebetriebe, Hotels und öffentliche Einrichtungen vertrauen auf unsere Glasreinigung.',
  ...
  },
  {
    ...
    beschreibung: 'Niederbayern verdient erstklassige Glasreinigung. Von der Innenstadt bis zum Industriegebiet – streifenfreie Fenster für alle.',
  ...
  },
  {
    ...
    beschreibung: 'Die Dreiflüssestadt mit Charakter. Altstadt, Universität und Gewerbe – wir reinigen Ihre Glasflächen nach Ihren Anforderungen.',
      ...
      <div className="w-full max-w-[1800px] mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-20">
        ...
        <div className="grid md:grid-cols-2 gap-6 sm:gap-8 lg:gap-12">
          ...
          <div className="flex flex-col justify-center">
            ...
            >
              Glasreinigung in {active.name} anfragen
