...
const processSteps = [
  ...
  },
  {
    ...
    icon: MapPin,
    title: 'Besichtigung',
    description: 'Wir schauen uns die Glasflächen vor Ort an und besprechen Ihre Anforderungen.',
    time: '1-2 Tage',
  },
  {
    number: '03',
  ...
  },
  {
    ...
    icon: Sparkles,
    title: 'Reinigung',
    description: 'Unsere Glasreiniger kommen zum vereinbarten Termin. Streifenfreies Ergebnis garantiert.',
    time: '3-5 Tage',
  },
]
      ...
      <div className="w-full max-w-[1800px] mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-20">
        ...
        <div className="text-center max-w-3xl mx-auto mb-8 sm:mb-12 lg:mb-16">
          ...
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-[#012956] leading-tight mb-4 sm:mb-6">
            In 4 Schritten zu streifenfreien Fenstern
          </h2>
          <p className="text-base sm:text-lg text-gray-600 font-semibold leading-relaxed">
            Vom ersten Kontakt bis zur fertigen Glasreinigung –
        ...
        <div className="mt-10 sm:mt-12 lg:mt-16 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 sm:gap-6 bg-white rounded-[6px] p-5 sm:p-6 lg:p-8">
          <p className="text-sm sm:text-base lg:text-lg text-gray-600 font-semibold">
            <strong className="text-[#012956]">Gesamtdauer:</strong> Durchschnittlich 5-7 Werktage vom Erstkontakt bis zu streifenfreien Fenstern.
          </p>
          <a
            href="#kontakt"
