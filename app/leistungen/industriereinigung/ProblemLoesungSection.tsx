...
import { ArrowRight, AlertTriangle, Clock, Shield, Wrench } from 'lucide-react'

const probleme = [
  {
    icon: AlertTriangle,
    problem: 'Öl und Fett auf dem Hallenboden – Unfallgefahr',
    loesung: 'Professionelle Entölung mit Spezialgeräten. Wir entfernen auch hartnäckige Verschmutzungen und versiegeln den Boden auf Wunsch.',
  },
  {
    icon: Clock,
    problem: 'Audit steht an – die Halle muss schnell sauber sein',
    loesung: 'Wir sind innerhalb von 2 Stunden vor Ort. Intensivreinigung auch am Wochenende oder in der Nacht möglich.',
  },
  {
    icon: Shield,
    problem: 'Die eigene Reinigung schafft es nicht mehr',
    loesung: 'Wir übernehmen komplett oder ergänzen Ihr Team. Mit professioneller Ausrüstung arbeiten wir schneller und gründlicher.',
  },
  {
    icon: Wrench,
    problem: 'Maschinen verstauben – Wartungsintervalle werden kürzer',
    loesung: 'Regelmäßige Maschinenreinigung nach Herstellervorgaben. Weniger Ausfälle, längere Lebensdauer.',
  },
]
      ...
      <div className="w-full max-w-[1800px] mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-20">
        ...
        <div className="max-w-3xl mb-8 sm:mb-12 lg:mb-16">
          ...
          <p className="text-base sm:text-lg text-gray-600 font-semibold leading-relaxed">
            In Produktionshallen und Industriebetrieben entstehen besondere Herausforderungen.
            Wir kennen sie – und haben die passenden Lösungen.
          </p>
        </div>
        ...
        <div className="mt-10 sm:mt-12 lg:mt-16 grid md:grid-cols-2 gap-6 sm:gap-8 items-center">
          ...
          <div className="md:pl-4 lg:pl-8">
            <h3 className="text-xl sm:text-2xl lg:text-3xl font-bold text-[#012956] mb-3 sm:mb-4">
              Produktion und Reinigung – kein Widerspruch
            </h3>
            <p className="text-gray-600 font-semibold leading-relaxed mb-4 sm:mb-6 text-sm sm:text-base">
              Wir reinigen im laufenden Betrieb, in Schichtpausen oder am Wochenende.
              Unsere Teams sind auf Industrieumgebungen geschult und wissen, worauf es ankommt:
              Sicherheit, Gründlichkeit und keine Störung Ihrer Produktion.
            </p>
            <a
              href="#kontakt"
