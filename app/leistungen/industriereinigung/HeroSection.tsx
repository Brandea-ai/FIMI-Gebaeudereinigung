...
export default function HeroSection() {
  return (
    <section id="hero" className="relative min-h-[85vh] sm:min-h-[90vh] flex items-center">
      {/* Background Image - Generiertes Industriehallen-Bild */}
      <div className="absolute inset-0">
        <picture>
          <source
            srcSet="/images/leistungen/industriereinigung/hero-industriehalle-384w.avif 384w, /images/leistungen/industriereinigung/hero-industriehalle-768w.avif 768w, /images/leistungen/industriereinigung/hero-industriehalle-1024w.avif 1024w, /images/leistungen/industriereinigung/hero-industriehalle.avif 1376w"
            sizes="100vw"
            type="image/avif"
          />
          <source
            srcSet="/images/leistungen/industriereinigung/hero-industriehalle-384w.webp 384w, /images/leistungen/industriereinigung/hero-industriehalle-768w.webp 768w, /images/leistungen/industriereinigung/hero-industriehalle-1024w.webp 1024w, /images/leistungen/industriereinigung/hero-industriehalle.avif 1376w"
            sizes="100vw"
            type="image/webp"
          />
          <Image
            src="/images/leistungen/industriereinigung/hero-industriehalle.avif"
            alt="Professionelle Industriereinigung - Saubere Produktionshalle"
            fill
        ...
        <div className="w-full max-w-[1800px] mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-20 py-16 sm:py-20 lg:py-32">
          ...
          <div className="max-w-4xl">
            ...
            <p className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-[#109387] mb-4 sm:mb-6">
              Saubere Produktion – im laufenden Betrieb, ohne Stillstand
            </p>

            {/* Description */}
            <p className="text-sm sm:text-base lg:text-xl text-white/80 font-semibold leading-relaxed mb-6 sm:mb-8 lg:mb-10 max-w-3xl">
              Industriereinigung für Produktionshallen, Maschinen und Anlagen. Wir reinigen in
              Schichtpausen, nachts oder am Wochenende – ohne Ihre Fertigung zu unterbrechen.
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 mb-6 sm:mb-8 lg:mb-10">
              ...
              <div className="flex items-center gap-2.5 sm:gap-3 bg-white/10 backdrop-blur-sm rounded-[6px] px-3 sm:px-4 py-2.5 sm:py-3">
                ...
                <div>
                  <span className="text-white font-bold block text-sm sm:text-base">Geschultes Team</span>
                  <span className="text-white/60 text-xs sm:text-sm font-semibold">Industrieerfahren</span>
                </div>
              </div>
              <div className="flex items-center gap-2.5 sm:gap-3 bg-white/10 backdrop-blur-sm rounded-[6px] px-3 sm:px-4 py-2.5 sm:py-3">
                <Shield className="w-5 h-5 sm:w-6 sm:h-6 text-[#109387] flex-shrink-0" />
                <div>
                  <span className="text-white font-bold block text-sm sm:text-base">Laufender Betrieb</span>
                  <span className="text-white/60 text-xs sm:text-sm font-semibold">Keine Stillstände</span>
                </div>
              </div>
            </div>
