  ...
  return (
    <section id="hero" className="relative min-h-[85vh] sm:min-h-[90vh] flex items-center">
      ...
      <div className="absolute inset-0">
        <Image
          src="https://images.unsplash.com/photo-1565688534245-05d6b5be184a?q=80&w=3840&auto=format&fit=crop"
          alt="Professionelle Industriereinigung in Produktionshalle"
          fill
