...
const processSteps = [
  ...
  },
  {
    ...
    icon: MapPin,
    title: 'Besichtigung',
    description: 'Wir kommen kostenfrei zu Ihnen und schauen uns Ihre Hallen und Maschinen an.',
    time: '1-2 Tage',
  },
  {
    number: '03',
  ...
  },
  {
    ...
    icon: Sparkles,
    title: 'Start',
    description: 'Nach Ihrer Zusage starten wir – auch kurzfristig am Wochenende oder nachts.',
    time: '3-5 Tage',
  },
]
      ...
      <div className="w-full max-w-[1800px] mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-20">
        ...
        <div className="text-center max-w-3xl mx-auto mb-8 sm:mb-12 lg:mb-16">
          ...
          <p className="text-base sm:text-lg text-gray-600 font-semibold leading-relaxed">
            Vom ersten Kontakt bis zur Reinigung Ihrer Hallen –
