...
import { ArrowRight, Phone, CheckCircle, TrendingDown, Users, Shield } from 'lucide-react'
        ...
        <div className="w-full max-w-[1800px] mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-20 py-16 sm:py-20 lg:py-32">
          ...
          <div className="max-w-4xl">
            ...
            <p className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-[#109387] mb-4 sm:mb-6">
              Einkaufskosten senken,<br />ohne Ihr Team zu belasten
            </p>

            {/* Description */}
            <p className="text-sm sm:text-base lg:text-xl text-white/80 font-semibold leading-relaxed mb-6 sm:mb-8 lg:mb-10 max-w-3xl">
              Steigende Materialkosten, überlastete Einkaufsabteilungen, Lieferantenrisiken:
              Wir bringen externes Know-how in Ihr Unternehmen. Ob Kostenoptimierung,
              Lieferantenmanagement oder Ausschreibungsbegleitung – messbare Ergebnisse statt Beratungsfloskeln.
            </p>
