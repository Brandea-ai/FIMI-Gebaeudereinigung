    ...
    <section className="section-padding bg-white">
      <div className="container-custom">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="mb-6">Warum FIMI Beschaffungsmanagement?</h2>
          <p className="text-xl text-gray-600">
            Unser Beschaffungsmanagement vereint Effizienz, Kostenkontrolle und zuverlässige Lieferung für Ihren Bedarf.
          </p>
        </div>
