      ...
      <div className="w-full max-w-[1800px] mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-20">
        ...
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-16">
          ...
          <div>
            ...
            <p className="text-base sm:text-lg lg:text-xl text-white/70 font-semibold leading-relaxed mb-6 sm:mb-8">
            ...
            <div className="grid sm:grid-cols-3 gap-4 sm:gap-6 mb-8 sm:mb-10">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-[6px] bg-[#109387]/20 flex items-center justify-center flex-shrink-0">
                  <TrendingDown className="w-5 h-5 sm:w-6 sm:h-6 text-[#109387]" />
                </div>
                <div>
                  <span className="text-white font-bold text-sm sm:text-base block">5-15%</span>
                  <span className="text-white/60 text-xs sm:text-sm font-semibold">Einsparpotenzial</span>
                </div>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-[6px] bg-[#109387]/20 flex items-center justify-center flex-shrink-0">
                  <Clock className="w-5 h-5 sm:w-6 sm:h-6 text-[#109387]" />
                </div>
                <div>
                  <span className="text-white font-bold text-sm sm:text-base block">2 Wochen</span>
                  <span className="text-white/60 text-xs sm:text-sm font-semibold">bis Potenzialanalyse</span>
                </div>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-[6px] bg-[#109387]/20 flex items-center justify-center flex-shrink-0">
                  <Shield className="w-5 h-5 sm:w-6 sm:h-6 text-[#109387]" />
                </div>
                <div>
                  <span className="text-white font-bold text-sm sm:text-base block">Kostenfrei</span>
                  <span className="text-white/60 text-xs sm:text-sm font-semibold">Erstberatung</span>
                </div>
              </div>
            </div>
