...
import { ArrowRight, Phone, CheckCircle, Building2, Home, Factory, Landmark, ShoppingBag, GraduationCap } from 'lucide-react'

// 6 beliebteste Branchen für Fassadenreinigung
const branchen = [
        ...
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-16">
          ...
          <div>
            ...
            <h3 className="text-xl sm:text-2xl lg:text-3xl font-bold text-white mb-4 sm:mb-6">
              Fassadenreinigung für Ihre Branche
            </h3>
