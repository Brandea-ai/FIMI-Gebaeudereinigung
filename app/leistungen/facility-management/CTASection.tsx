...
import { ArrowRight, Phone, CheckCircle, Users, Briefcase, Building2, Home, Factory, Stethoscope, ShoppingBag, UtensilsCrossed } from 'lucide-react'
      ...
      <div className="w-full max-w-[1800px] mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-20">
        ...
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-16">
          ...
          <div>
            ...
            {/* Karriere CTA */}
            <div className="bg-white/10 backdrop-blur-sm rounded-[6px] p-5 sm:p-6">
              <div className="flex items-start gap-3 sm:gap-4">
                ...
                <div>
                  ...
                  <p className="text-white/70 font-semibold text-sm sm:text-base mb-3">
                    Wir suchen engagierte Mitarbeiter für unser wachsendes Team.
                  </p>
                  <Link
                    href="/karriere"
                    className="inline-flex items-center gap-2 text-[#109387] font-bold text-sm hover:text-white transition-colors group"
                  >
          ...
          <div className="bg-white rounded-[6px] p-5 sm:p-6 lg:p-10">
            <h3 className="text-xl sm:text-2xl lg:text-3xl font-bold text-[#012956] mb-3 sm:mb-4">
              Jetzt Facility Management anfragen
            </h3>
            <p className="text-sm sm:text-base text-gray-600 font-semibold leading-relaxed mb-5 sm:mb-6">
              Kostenfreie Besichtigung, transparentes Angebot, ein Ansprechpartner für alles.
            </p>
            ...
            <div className="space-y-2 sm:space-y-3">
              <div className="flex items-center gap-2 sm:gap-3">
                ...
                <span className="text-gray-700 font-semibold text-xs sm:text-sm lg:text-base">
