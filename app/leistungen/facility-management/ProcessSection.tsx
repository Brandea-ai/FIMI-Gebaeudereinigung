...
const processSteps = [
  ...
  },
  {
    ...
    icon: MapPin,
    title: 'Besichtigung',
    description: 'Wir kommen kostenfrei zu Ihnen und schauen uns alle Gebäudebereiche an.',
    time: '1-2 Tage',
  },
  {
    number: '03',
    icon: FileText,
    title: 'Angebot',
    description: 'Sie erhalten ein maßgeschneidertes FM-Angebot mit transparenten Festpreisen.',
    time: '24 Stunden',
  },
  {
    number: '04',
    icon: Sparkles,
    title: 'Start',
    description: 'Nach Ihrer Zusage starten wir und koordinieren alle Dienstleistungen für Sie.',
    time: '3-5 Tage',
  },
]
      ...
      <div className="w-full max-w-[1800px] mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-20">
        ...
        <div className="text-center max-w-3xl mx-auto mb-8 sm:mb-12 lg:mb-16">
          ...
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-[#012956] leading-tight mb-4 sm:mb-6">
            In 4 Schritten zum Facility Management
          </h2>
          <p className="text-base sm:text-lg text-gray-600 font-semibold leading-relaxed">
            Vom ersten Kontakt bis zur laufenden Betreuung –
        ...
        >
          <p className="text-sm sm:text-base lg:text-lg text-gray-600 font-semibold">
            <strong className="text-[#012956]">Gesamtdauer:</strong> Durchschnittlich 5-7 Werktage vom Erstkontakt bis zur laufenden Betreuung.
          </p>
