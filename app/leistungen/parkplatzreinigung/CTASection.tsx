...
import { ArrowRight, Phone, CheckCircle, ShoppingCart, Building2, Car, Truck, UtensilsCrossed, Home } from 'lucide-react'

// 6 relevante Branchen für Parkplatzreinigung
const branchen = [
  { slug: 'einzelhandel', name: 'Einzelhandel', icon: ShoppingCart },
        ...
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-16">
          ...
          <div>
            ...
            <div className="mt-8 sm:mt-10 pt-6 sm:pt-8 border-t border-white/20">
              <p className="text-white/60 font-semibold text-xs sm:text-sm uppercase tracking-wide mb-3 sm:mb-4">
                Verwandte Leistungen
              </p>
          ...
          <div className="bg-white rounded-[6px] p-5 sm:p-6 lg:p-10">
            ...
            <p className="text-sm sm:text-base text-gray-600 font-semibold leading-relaxed mb-5 sm:mb-6">
              ...
              Ihr Parkplatz ist in guten Händen.
            </p>
