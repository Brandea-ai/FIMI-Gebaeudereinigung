...
const processSteps = [
  ...
  },
  {
    ...
    icon: MapPin,
    title: 'Besichtigung',
    description: 'Wir kommen kostenfrei zu Ihnen und begutachten die Parkflächen vor Ort.',
    time: '1-2 Tage',
  },
  {
    number: '03',
      ...
      <div className="w-full max-w-[1800px] mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-20">
        ...
        <div className="text-center max-w-3xl mx-auto mb-8 sm:mb-12 lg:mb-16">
          ...
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-[#012956] leading-tight mb-4 sm:mb-6">
            In 4 Schritten zum sauberen Parkplatz
          </h2>
          <p className="text-base sm:text-lg text-gray-600 font-semibold leading-relaxed">
            Vom ersten Kontakt bis zur ersten Reinigung – unkompliziert, transparent
            ...
            >
              ...
              <div className="flex items-start gap-3 sm:gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  {/* Time Badge */}
                  <div className="inline-flex items-center bg-white rounded-[6px] px-2 sm:px-2.5 py-1 border border-gray-200">
