...
const schritte = [
  ...
  },
  {
    ...
    icon: ClipboardCheck,
    titel: 'Besichtigung',
    beschreibung: 'Wir kommen kostenfrei zu Ihnen und nehmen alle Fenster und Glasflächen auf.',
    details: ['Kostenfrei & unverbindlich', 'Aufmaß vor Ort', 'Beratung zu Intervallen'],
  },
  {
    nummer: '03',
    icon: FileText,
    titel: 'Angebot',
    beschreibung: 'Sie erhalten ein transparentes Festpreisangebot – ohne versteckte Kosten.',
  ...
  },
  {
    ...
    icon: Sparkles,
    titel: 'Start',
    beschreibung: 'Ihr festes Reinigungsteam übernimmt. Sie genießen klaren Durchblick.',
      ...
      <div className="w-full max-w-[1800px] mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-20">
        ...
        <div className="max-w-3xl mb-8 sm:mb-12 lg:mb-16">
          ...
          <p className="text-base sm:text-lg text-gray-600 font-semibold leading-relaxed">
            Von der ersten Anfrage bis zum regelmäßigen Service – wir machen es Ihnen so einfach wie möglich.
          </p>
        </div>
