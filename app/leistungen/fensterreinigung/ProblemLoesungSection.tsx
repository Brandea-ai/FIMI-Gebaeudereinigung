...
import { ArrowRight, Droplets, Mountain, Clock, ThumbsDown } from 'lucide-react'

const probleme = [
  {
    icon: Droplets,
    problem: 'Die Fenster haben Schlieren und Wasserflecken',
    loesung: 'Wir arbeiten mit Osmose-Wasser und professioneller Technik. Das Ergebnis: kristallklare Scheiben ohne Rückstände – garantiert streifenfrei.',
  },
  {
    icon: Mountain,
    problem: 'Manche Fenster sind schwer erreichbar oder gefährlich hoch',
    loesung: 'Ob Dachfenster, Glasfassade oder Wintergarten – mit Teleskopstangen, Hebebühnen und geschultem Personal erreichen wir jede Glasfläche sicher.',
  },
  {
    icon: Clock,
    problem: 'Die Fensterreinigung wird immer wieder verschoben',
    loesung: 'Mit festen Intervallen und zuverlässiger Terminplanung sorgen wir dafür, dass Ihre Fenster immer gepflegt aussehen. Sie müssen sich um nichts kümmern.',
  },
  {
    icon: ThumbsDown,
    problem: 'Der letzte Fensterputzer hat die Rahmen vergessen',
    loesung: 'Bei uns ist Rahmenreinigung inklusive. Wir reinigen Glas, Rahmen, Fensterbänke und Falze – ein Komplett-Service ohne Aufpreis.',
  },
]
      ...
      <div className="w-full max-w-[1800px] mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-20">
        ...
        <div className="max-w-3xl mb-8 sm:mb-12 lg:mb-16">
          ...
          <p className="text-base sm:text-lg text-gray-600 font-semibold leading-relaxed">
            Schmutzige Fenster fallen sofort auf – Ihren Kunden, Ihren Mitarbeitern, Ihren Besuchern.
            Wir sorgen dafür, dass der erste Eindruck stimmt.
          </p>
        </div>
        ...
        <div className="mt-10 sm:mt-12 lg:mt-16 grid md:grid-cols-2 gap-6 sm:gap-8 items-center">
          <div className="relative h-[220px] sm:h-[280px] md:h-[350px] lg:h-[400px] rounded-[6px] overflow-hidden">
            <Image
              ...
              alt="Klare saubere Fensterfront mit Blick nach draußen"
              fill
          ...
          <div className="md:pl-4 lg:pl-8">
            <h3 className="text-xl sm:text-2xl lg:text-3xl font-bold text-[#012956] mb-3 sm:mb-4">
              Klare Sicht, klarer Eindruck
            </h3>
            <p className="text-gray-600 font-semibold leading-relaxed mb-4 sm:mb-6 text-sm sm:text-base">
              Saubere Fenster machen mehr als nur hübsch aussehen. Sie lassen natürliches
              Licht herein, verbessern das Raumklima und zeigen Ihren Kunden: Hier wird
              auf Details geachtet. Lassen Sie die Fensterreinigung Profis machen.
            </p>
            <a
              href="#kontakt"
