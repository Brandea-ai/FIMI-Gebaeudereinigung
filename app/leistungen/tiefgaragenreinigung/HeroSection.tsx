...
import { ArrowRight, Phone, CheckCircle, Clock, Shield, Droplets } from 'lucide-react'
  ...
  return (
    <section id="hero" className="relative min-h-[85vh] sm:min-h-[90vh] flex items-center">
      ...
      <div className="absolute inset-0">
        <Image
          src="https://images.unsplash.com/photo-1590674899484-d5640e854abe?q=80&w=3840&auto=format&fit=crop"
          alt="Professionelle Tiefgaragenreinigung - saubere Parkflächen"
          fill
        ...
        <div className="w-full max-w-[1800px] mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-20 py-16 sm:py-20 lg:py-32">
          ...
          <nav className="mb-6 sm:mb-8" aria-label="Breadcrumb">
            <ol className="flex items-center gap-1.5 sm:gap-2 text-xs sm:text-sm font-semibold">
              ...
              <li className="text-white/40">/</li>
              <li className="text-[#109387]">Tiefgaragenreinigung</li>
            </ol>
          </nav>
          ...
          <div className="max-w-4xl">
            ...
            <p className="text-sm sm:text-base lg:text-xl text-white/80 font-semibold leading-relaxed mb-6 sm:mb-8 lg:mb-10 max-w-3xl">
              Professionelle Tiefgaragenreinigung für Wohnanlagen, Gewerbeimmobilien und Parkhäuser.
              Wir entfernen hartnäckige Verschmutzungen, erfüllen Ihre Verkehrssicherungspflicht und
              sorgen für einen gepflegten ersten Eindruck – auch im laufenden Betrieb.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 mb-6 sm:mb-8 lg:mb-10">
              ...
              <div className="flex items-center gap-2.5 sm:gap-3 bg-white/10 backdrop-blur-sm rounded-[6px] px-3 sm:px-4 py-2.5 sm:py-3">
                ...
                <div>
                  ...
                  <span className="text-white/60 text-xs sm:text-sm font-semibold">Keine Sperrung</span>
                </div>
              </div>
              <div className="flex items-center gap-2.5 sm:gap-3 bg-white/10 backdrop-blur-sm rounded-[6px] px-3 sm:px-4 py-2.5 sm:py-3">
                <Droplets className="w-5 h-5 sm:w-6 sm:h-6 text-[#109387] flex-shrink-0" />
                <div>
                  <span className="text-white font-bold block text-sm sm:text-base">Festpreis</span>
                  <span className="text-white/60 text-xs sm:text-sm font-semibold">Transparent pro qm</span>
                </div>
              </div>
            </div>
