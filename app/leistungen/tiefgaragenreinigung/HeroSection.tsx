  ...
  return (
    <section className="relative min-h-[85vh] flex items-center">
      <div className="absolute inset-0">
        <Image src="https://images.unsplash.com/photo-1590674899484-d5640e854abe?q=80&w=3540&auto=format&fit=crop" alt="Tiefgaragenreinigung" fill className="object-cover" priority />
      ...
      <div className="relative z-10 w-full">
        <div className="w-full max-w-[1800px] mx-auto px-6 lg:px-12 xl:px-20 py-32">
          ...
          <div className="max-w-4xl">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-white leading-[1.05] mb-6">Tiefgaragenreinigung</h1>
            <p className="text-xl md:text-2xl lg:text-3xl font-bold text-[#109387] mb-8">Professionelle Reinigung von Tiefgaragen und Parkhäusern</p>
