    ...
    <section id="blog" className="py-12 sm:py-16 lg:py-28 bg-[#f8f9fa]">
      <div className="w-full max-w-[1800px] mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-20">
        ...
        <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-4 sm:gap-6 mb-8 sm:mb-10 lg:mb-12">
          <div className="max-w-2xl">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-[#012956] leading-tight mb-3 sm:mb-4">
              Wissen rund um Tiefgaragenreinigung
            </h2>
            <p className="text-sm sm:text-base lg:text-lg text-gray-600 font-semibold leading-relaxed">
              Praktische Tipps für WEGs und Hausverwaltungen, saisonale Hinweise und Einblicke
              in professionelle Tiefgaragenpflege.
            </p>
          </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
          {relatedPosts.map((post, index) => (
            <Link
              ...
              className="group bg-white rounded-[6px] overflow-hidden hover:shadow-xl transition-all duration-300 border border-gray-100"
            >
              {/* Image */}
        ...
        <div className="mt-10 sm:mt-12 lg:mt-16 grid sm:grid-cols-2 gap-4 sm:gap-6">
          ...
          >
            <div>
              ...
              <p className="text-white/70 font-semibold text-xs sm:text-sm">
                Faire Bezahlung, feste Arbeitszeiten, moderne Maschinen.
              </p>
            </div>
          ...
          <Link
            href="/ueber-uns"
            className="bg-white rounded-[6px] p-5 sm:p-6 lg:p-8 flex items-center justify-between group hover:bg-gray-50 transition-colors border border-gray-200"
          >
            <div>
              <span className="text-[#109387] font-bold text-xs sm:text-sm uppercase tracking-wide mb-1.5 sm:mb-2 block">
                Über FIMI
