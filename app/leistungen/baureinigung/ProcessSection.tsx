...
const processSteps = [
  {
    ...
    icon: Phone,
    title: 'Anfrage',
    description: 'Rufen Sie an oder füllen Sie das Kontaktformular aus. Teilen Sie uns Objektgröße, Bauphase und gewünschten Termin mit.',
    time: '5 Minuten',
  },
  {
    number: '02',
    icon: MapPin,
    title: 'Besichtigung',
    description: 'Wir kommen kostenfrei zu Ihnen auf die Baustelle und bewerten den Ist-Zustand sowie den erforderlichen Reinigungsumfang.',
    time: '1-2 Tage',
  },
  {
    number: '03',
    icon: FileText,
    title: 'Angebot',
    description: 'Sie erhalten ein detailliertes Festpreisangebot – transparent, ohne versteckte Kosten, inklusive aller vereinbarten Leistungen.',
    time: '48 Stunden',
  },
  {
    number: '04',
    icon: Sparkles,
    title: 'Umsetzung',
    description: 'Unser geschultes Team führt die Baureinigung termingerecht durch. Sie erhalten ein bezugsfertiges Gebäude zur Übergabe.',
      ...
      <div className="w-full max-w-[1800px] mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-20">
        ...
        <div className="text-center max-w-3xl mx-auto mb-8 sm:mb-12 lg:mb-16">
          ...
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-[#012956] leading-tight mb-4 sm:mb-6">
            In 4 Schritten zur bezugsfertigen Immobilie
          </h2>
          <p className="text-base sm:text-lg text-gray-600 font-semibold leading-relaxed">
            Von der ersten Anfrage bis zur termingerechten Übergabe –
            wir machen Ihnen die Baureinigung so einfach wie möglich.
          </p>
        </div>
        ...
        >
          <p className="text-sm sm:text-base lg:text-lg text-gray-600 font-semibold group-hover:text-white transition-colors">
            <strong className="text-[#012956] group-hover:text-[#109387]">Typische Vorlaufzeit:</strong> Bei Standardprojekten 3-5 Werktage. Notfall-Service innerhalb von 24 Stunden möglich.
          </p>
          <span className="inline-flex items-center justify-center gap-2 bg-[#109387] group-hover:bg-white text-white group-hover:text-[#012956] font-bold px-5 sm:px-6 lg:px-8 py-3 sm:py-3.5 lg:py-4 rounded-[6px] transition-colors text-sm sm:text-base whitespace-nowrap flex-shrink-0">
            Jetzt anfragen
