...
import { ArrowRight, Phone, CheckCircle, Sparkles, Building2, Warehouse, PanelTop } from 'lucide-react'

// Verwandte Leistungen
const verwandteLeistungen = [
  { slug: 'fensterreinigung', name: 'Fensterreinigung', icon: PanelTop },
  { slug: 'hallenreinigung', name: 'Hallenreinigung', icon: Warehouse },
  { slug: 'industriereinigung', name: 'Industriereinigung', icon: Building2 },
        ...
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-16">
          ...
          <div>
            ...
            <h3 className="text-xl sm:text-2xl lg:text-3xl font-bold text-white mb-4 sm:mb-6">
              Nach der Baureinigung weiter betreut
            </h3>
            <p className="text-white/70 font-semibold mb-6 sm:mb-8 leading-relaxed">
              Ist das Gebäude bezugsfertig, beginnt der reguläre Betrieb.
              Wir begleiten Sie gerne weiter – mit regelmäßiger Unterhaltsreinigung,
              Fensterreinigung oder Facility Management.
            </p>
          ...
          <div className="bg-white rounded-[6px] p-5 sm:p-6 lg:p-10">
            ...
            <p className="text-sm sm:text-base text-gray-600 font-semibold leading-relaxed mb-5 sm:mb-6">
              Kostenfreie Besichtigung, transparentes Festpreisangebot, bezugsfertige Übergabe.
            </p>
