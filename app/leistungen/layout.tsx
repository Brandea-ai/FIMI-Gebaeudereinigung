...
export const metadata: Metadata = {
  ...
  description: 'Entdecken Sie unsere 18 professionellen Reinigungsservices: Büroreinigung, Industriereinigung, Facility Management & mehr. ✓ ISO zertifiziert ✓ Kostenfreie Besichtigung ✓ Bayern',
