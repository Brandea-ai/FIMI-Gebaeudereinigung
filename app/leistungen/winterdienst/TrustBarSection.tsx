...
import { Snowflake, Building2, Clock, ShieldCheck } from 'lucide-react'

const stats = [
  {
    icon: Snowflake,
    value: '8+',
    label: 'Winter betreut',
    sublabel: 'Erfahrung seit 2016',
  },
  {
    icon: Building2,
    value: '50+',
    label: 'Objekte betreut',
    sublabel: 'Gewerbe & Verwaltung',
  },
  {
    icon: Clock,
    value: '2h',
    label: 'Reaktionszeit',
    sublabel: 'Bei Schneefall',
  },
  {
    icon: ShieldCheck,
    value: '100%',
    label: 'Haftungsschutz',
    sublabel: 'Vertraglich gesichert',
  },
]
