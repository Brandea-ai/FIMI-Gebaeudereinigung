    ...
    <section className="section-padding bg-white">
      <div className="container-custom">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="mb-6">Warum FIMI Winterdienst?</h2>
          <p className="text-xl text-gray-600">
            Unser Winterdienst vereint Zuverlässigkeit, schnelle Reaktionszeiten und professionelle Ausrüstung für sichere Wege.
          </p>
        </div>
