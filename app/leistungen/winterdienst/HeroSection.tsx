...
import { ArrowRight, Phone, CheckCircle, Clock, Shield, Snowflake } from 'lucide-react'

export default function HeroSection() {
  return (
    <section id="hero" className="relative min-h-[85vh] sm:min-h-[90vh] flex items-center">
      {/* Background Image - Winterliche Szene */}
      <div className="absolute inset-0">
        <Image
          src="https://images.unsplash.com/photo-1517299321609-52687d1bc55a?q=80&w=3840&auto=format&fit=crop"
          alt="Professioneller Winterdienst - Schneeräumung auf Gewerbeflächen"
          fill
        ...
        <div className="w-full max-w-[1800px] mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-20 py-16 sm:py-20 lg:py-32">
          ...
          <nav className="mb-6 sm:mb-8" aria-label="Breadcrumb">
            <ol className="flex items-center gap-1.5 sm:gap-2 text-xs sm:text-sm font-semibold">
              ...
              <li className="text-white/40">/</li>
              <li className="text-[#109387]">Winterdienst</li>
            </ol>
          </nav>
          ...
          <div className="max-w-4xl">
            ...
            <div className="inline-flex items-center bg-[#109387]/20 backdrop-blur-sm border border-[#109387]/30 rounded-[6px] px-3 sm:px-4 py-1.5 sm:py-2 mb-4 sm:mb-6">
              <Snowflake className="w-4 h-4 sm:w-5 sm:h-5 text-[#109387] mr-2" />
            ...
            <p className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-[#109387] mb-4 sm:mb-6">
              Es schneit – und Ihre Flächen sind in 2 Stunden sicher
            </p>

            {/* Description */}
            <p className="text-sm sm:text-base lg:text-xl text-white/80 font-semibold leading-relaxed mb-6 sm:mb-8 lg:mb-10 max-w-3xl">
              Professionelle Schneeräumung und Streudienst für Gewerbe, Hausverwaltungen und
              Industrie. Wir übernehmen Ihre Verkehrssicherungspflicht – mit rechtssicherer
              Dokumentation und 24/7-Bereitschaft von November bis März.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 mb-6 sm:mb-8 lg:mb-10">
              <div className="flex items-center gap-2.5 sm:gap-3 bg-white/10 backdrop-blur-sm rounded-[6px] px-3 sm:px-4 py-2.5 sm:py-3">
                ...
                <div>
                  <span className="text-white font-bold block text-sm sm:text-base">24/7 Bereitschaft</span>
                  <span className="text-white/60 text-xs sm:text-sm font-semibold">Nov – März</span>
                </div>
              </div>
              <div className="flex items-center gap-2.5 sm:gap-3 bg-white/10 backdrop-blur-sm rounded-[6px] px-3 sm:px-4 py-2.5 sm:py-3">
                <Shield className="w-5 h-5 sm:w-6 sm:h-6 text-[#109387] flex-shrink-0" />
                <div>
                  <span className="text-white font-bold block text-sm sm:text-base">Haftungsübernahme</span>
                  <span className="text-white/60 text-xs sm:text-sm font-semibold">Vertraglich gesichert</span>
                </div>
              </div>
              <div className="flex items-center gap-2.5 sm:gap-3 bg-white/10 backdrop-blur-sm rounded-[6px] px-3 sm:px-4 py-2.5 sm:py-3">
                <Snowflake className="w-5 h-5 sm:w-6 sm:h-6 text-[#109387] flex-shrink-0" />
                <div>
                  <span className="text-white font-bold block text-sm sm:text-base">2h Reaktionszeit</span>
                  <span className="text-white/60 text-xs sm:text-sm font-semibold">Bei Schneefall</span>
                </div>
              </div>
            </div>
