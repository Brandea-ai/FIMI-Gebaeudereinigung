...
import { ArrowRight, Phone, CheckCircle, Building2, Home, ShoppingBag, Factory, Stethoscope, Warehouse } from 'lucide-react'

// Relevante Branchen für Winterdienst
const branchen = [
  { slug: 'buero-verwaltung', name: 'Büro & Verwaltung', icon: Building2 },
  { slug: 'wohnungswirtschaft', name: 'Hausverwaltung', icon: Home },
  ...
  { slug: 'logistik-lager', name: 'Logistik', icon: Warehouse },
]
        ...
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-16">
          ...
          <div className="bg-white rounded-[6px] p-5 sm:p-6 lg:p-10">
            <h3 className="text-xl sm:text-2xl lg:text-3xl font-bold text-[#012956] mb-3 sm:mb-4">
              Jetzt für den Winter absichern
            </h3>
            <p className="text-sm sm:text-base text-gray-600 font-semibold leading-relaxed mb-5 sm:mb-6">
              Kostenfreie Besichtigung, transparentes Festpreis-Angebot, Haftungsübernahme inklusive.
            </p>
            ...
            <div className="space-y-2 sm:space-y-3">
              ...
              <div className="flex items-center gap-2 sm:gap-3">
                <CheckCircle className="w-4 h-4 sm:w-5 sm:h-5 text-[#109387] flex-shrink-0" />
                <span className="text-gray-700 font-semibold text-xs sm:text-sm lg:text-base">Haftungsübernahme vertraglich gesichert</span>
              </div>
            </div>
          </div>
