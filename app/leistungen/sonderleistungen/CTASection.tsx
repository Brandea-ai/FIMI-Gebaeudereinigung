...
const branchen = [
  ...
  { slug: 'gesundheitswesen', name: 'Gesundheitswesen', icon: Home },
  { slug: 'industrie-produktion', name: 'Industrie', icon: Shield },
  { slug: 'oeffentliche-einrichtungen', name: 'Öffentliche Einrichtungen', icon: Briefcase },
  { slug: 'banken-versicherungen', name: 'Banken & Versicherungen', icon: Calendar },
]

// Verwandte Leistungen
const leistungen = [
  { slug: 'unterhaltsreinigung', name: 'Unterhaltsreinigung' },
  { slug: 'bueroreinigung', name: 'Büroreinigung' },
  { slug: 'hotelreinigung', name: 'Hotelreinigung' },
        ...
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-16">
          ...
          <div>
            ...
            <div className="mb-8 sm:mb-10">
              ...
              {/* Branchen als Grid - Outlined Style */}
