...
import { ArrowRight, Phone, CheckCircle, Clock, Users, Award } from 'lucide-react'
        ...
        <div className="w-full max-w-[1800px] mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-20 py-16 sm:py-20 lg:py-32">
          ...
          <nav className="mb-6 sm:mb-8" aria-label="Breadcrumb">
            <ol className="flex items-center gap-1.5 sm:gap-2 text-xs sm:text-sm font-semibold">
              ...
              <li className="text-white/60" aria-hidden="true">/</li>
              <li className="text-[#109387]">Sonderleistungen</li>
            </ol>
          </nav>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 mb-6 sm:mb-8 lg:mb-10">
              <div className="flex items-center gap-2.5 sm:gap-3 bg-white/10 backdrop-blur-sm rounded-[6px] px-3 sm:px-4 py-2.5 sm:py-3">
                ...
                <div>
                  ...
                  <span className="text-white/80 text-xs sm:text-sm font-semibold">Rundum-Service</span>
                </div>
              </div>
              <div className="flex items-center gap-2.5 sm:gap-3 bg-white/10 backdrop-blur-sm rounded-[6px] px-3 sm:px-4 py-2.5 sm:py-3">
                ...
                <div>
                  ...
                  <span className="text-white/80 text-xs sm:text-sm font-semibold">Diskret & zuverlässig</span>
                </div>
              </div>
              <div className="flex items-center gap-2.5 sm:gap-3 bg-white/10 backdrop-blur-sm rounded-[6px] px-3 sm:px-4 py-2.5 sm:py-3">
                <Award className="w-5 h-5 sm:w-6 sm:h-6 text-[#109387] flex-shrink-0" aria-hidden="true" />
                <div>
