...
const relatedPosts = [
  ...
  },
  {
    ...
    title: 'Reinigungsintervalle richtig planen: So optimieren Sie Ihre Kosten',
    excerpt: 'Nicht jeder Raum braucht tägliche Reinigung. Wie Sie den optimalen Rhythmus finden.',
  ...
  {
    slug: 'qualitaetskontrolle-gebaeuereinigung',
    title: 'Qualitätskontrolle in der Gebäudereinigung: Worauf Sie achten sollten',
    excerpt: 'Wie professionelle Reinigungsunternehmen gleichbleibende Qualität sicherstellen.',
        ...
        <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6 mb-12">
          <div className="max-w-2xl">
            ...
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-[#012956] leading-tight mb-4">
              Wissen rund um Unterhaltsreinigung
            </h2>
