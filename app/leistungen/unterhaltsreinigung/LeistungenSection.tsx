...
export default function LeistungenSection() {
  return (
    <section className="py-20 lg:py-28 bg-white" id="leistungen">
      <div className="w-full max-w-[1800px] mx-auto px-6 lg:px-12 xl:px-20">
        ...
        <div className="max-w-4xl mb-16 lg:mb-20">
          ...
          <p className="text-lg text-gray-700 font-semibold leading-relaxed">
            Unterhaltsreinigung bedeutet regelmäßige, wiederkehrende Reinigung Ihrer Geschäftsräume.
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center mb-20 lg:mb-28">
          ...
          <div>
            ...
            <div className="space-y-4 text-gray-700 font-semibold leading-relaxed">
              ...
              <p>
                <strong className="text-[#012956]">Unsere Unterhaltsreinigung funktioniert anders:</strong> Ein festes Team
