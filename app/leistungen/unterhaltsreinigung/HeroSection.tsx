    ...
    <section className="relative min-h-[85vh] flex items-center">
      ...
      <div className="absolute inset-0">
        <Image
          ...
          alt="Unterhaltsreinigung - Regelmäßige professionelle Gebäudereinigung"
          fill
        ...
        <div className="w-full max-w-[1800px] mx-auto px-6 lg:px-12 xl:px-20 py-32">
          ...
          <div className="max-w-4xl">
            ...
            <p className="text-xl md:text-2xl lg:text-3xl font-bold text-[#109387] mb-8">
              Regelmäßige professionelle Reinigung Ihrer Geschäftsräume
            </p>

            <p className="text-lg lg:text-xl text-white/80 font-semibold leading-relaxed mb-10 max-w-3xl">
              [PLATZHALTER: Hier kommt die ausführliche Beschreibung der Unterhaltsreinigung.
              Täglich, wöchentlich oder nach Bedarf - wir passen uns Ihren Anforderungen an.]
            </p>
