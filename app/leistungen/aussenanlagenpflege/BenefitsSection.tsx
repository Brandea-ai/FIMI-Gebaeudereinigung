    ...
    <section className="section-padding bg-white">
      <div className="container-custom">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="mb-6">Warum FIMI Außenanlagenpflege?</h2>
          <p className="text-xl text-gray-600">
            Unsere Außenanlagenpflege vereint Qualität, regelmäßige Betreuung und Fachkompetenz für gepflegte Grünflächen.
          </p>
        </div>
