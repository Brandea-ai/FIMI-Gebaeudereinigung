            ...
            {schritte.map((schritt, index) => {
              ...
              return (
                <div key={schritt.nummer} className="relative">
                  {/* Step Card */}
                  <div className="bg-white rounded-[8px] p-5 sm:p-6 shadow-sm hover:shadow-lg transition-all duration-300 h-full group">
                    {/* Number + Icon */}
                    <div className="flex items-center gap-3 mb-4">
                      <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-[6px] bg-[#109387] flex items-center justify-center relative z-10">
                        <Icon className="w-6 h-6 sm:w-7 sm:h-7 text-white" strokeWidth={1.5} />
                      </div>
                      <span className="text-3xl sm:text-4xl font-bold text-[#012956]/10 group-hover:text-[#109387]/20 transition-colors">
                        {schritt.nummer}
                      </span>
                    </div>
