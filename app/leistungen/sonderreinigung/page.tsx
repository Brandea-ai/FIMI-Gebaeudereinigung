...
const faqSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Unsere Spezialteams bestehen aus staatlich geprüften Desinfektoren und zertifizierten Fachkräften. Wir arbeiten nach ISO 9001 und ISO 14001 Standards. Alle Mitarbeiter sind geschult im Umgang mit Gefahrstoffen.',
      },
    },
  ],
}
