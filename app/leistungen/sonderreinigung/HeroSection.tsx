...
import { ArrowRight, Phone, CheckCircle, Clock, Award, FileCheck } from 'lucide-react'
  ...
  return (
    <section id="hero" className="relative min-h-[85vh] sm:min-h-[90vh] flex items-center">
      ...
      <div className="absolute inset-0">
        <Image
          src="https://images.unsplash.com/photo-1581578731548-c64695cc6952?q=80&w=3840&auto=format&fit=crop"
          alt="Professionelle Sonderreinigung - Notfall-Service für Wasserschäden und Brandschäden"
          fill
        ...
        <div className="w-full max-w-[1800px] mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-20 py-16 sm:py-20 lg:py-32">
          ...
          <nav className="mb-6 sm:mb-8" aria-label="Breadcrumb">
            <ol className="flex items-center gap-1.5 sm:gap-2 text-xs sm:text-sm font-semibold">
              ...
              <li className="text-white/40">/</li>
              <li className="text-[#109387]">Sonderreinigung</li>
            </ol>
          </nav>
          ...
          <div className="max-w-4xl">
            ...
            <p className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-[#109387] mb-4 sm:mb-6">
              Wenn normale Reinigung nicht mehr reicht –<br className="hidden sm:block" />
              Wasserschaden, Brandschaden, Extremfälle
            </p>

            {/* Description */}
            <p className="text-sm sm:text-base lg:text-xl text-white/80 font-semibold leading-relaxed mb-6 sm:mb-8 lg:mb-10 max-w-3xl">
              Wasserschaden über Nacht? Brandschaden in der Produktion? Messie-Wohnung vom
              Vormieter? Wir übernehmen die Fälle, bei denen andere aufgeben. Mit staatlich
              geprüften Desinfektoren, 24h Notdienst und direkter Versicherungs-Abwicklung.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 mb-6 sm:mb-8 lg:mb-10">
              <div className="flex items-center gap-2.5 sm:gap-3 bg-white/10 backdrop-blur-sm rounded-[6px] px-3 sm:px-4 py-2.5 sm:py-3">
                ...
                <div>
                  <span className="text-white font-bold block text-sm sm:text-base">24h Notdienst</span>
                  <span className="text-white/60 text-xs sm:text-sm font-semibold">7 Tage die Woche</span>
                </div>
              </div>
              <div className="flex items-center gap-2.5 sm:gap-3 bg-white/10 backdrop-blur-sm rounded-[6px] px-3 sm:px-4 py-2.5 sm:py-3">
                <Award className="w-5 h-5 sm:w-6 sm:h-6 text-[#109387] flex-shrink-0" />
                <div>
                  <span className="text-white font-bold block text-sm sm:text-base">Staatl. Desinfektoren</span>
                  <span className="text-white/60 text-xs sm:text-sm font-semibold">Zertifizierte Fachkräfte</span>
                </div>
              </div>
              <div className="flex items-center gap-2.5 sm:gap-3 bg-white/10 backdrop-blur-sm rounded-[6px] px-3 sm:px-4 py-2.5 sm:py-3">
                <FileCheck className="w-5 h-5 sm:w-6 sm:h-6 text-[#109387] flex-shrink-0" />
                <div>
                  <span className="text-white font-bold block text-sm sm:text-base">Versicherung</span>
                  <span className="text-white/60 text-xs sm:text-sm font-semibold">Direkte Abwicklung</span>
                </div>
              </div>
            </div>
            ...
            <p className="mt-4 sm:mt-6 text-white/60 font-semibold text-xs sm:text-sm flex items-center gap-1.5 sm:gap-2">
              ...
              24h erreichbar – In 2-4 Stunden vor Ort bei Notfällen
            </p>
          </div>
