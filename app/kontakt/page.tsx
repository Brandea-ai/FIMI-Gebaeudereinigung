      ...
      <section className="py-20">
        <div className="container">
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div>
              <h2 className="text-3xl font-bold text-fimi-navy mb-8">Kontaktinformationen</h2>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <p className="font-semibold text-fimi-navy mb-1">Telefon</p>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <p className="font-semibold text-fimi-navy mb-1">E-Mail</p>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <p className="font-semibold text-fimi-navy mb-1">Adresse</p>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <p className="font-semibold text-fimi-navy mb-1">Öffnungszeiten</p>
                    <p className="text-gray-700">
            ...
            <div className="bg-gray-50 p-8 rounded-2xl">
              <h3 className="text-2xl font-bold text-fimi-navy mb-6">Anfrage senden</h3>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button
                  ...
                  className="w-full bg-fimi-turquoise text-white px-6 py-4 rounded-lg font-semibold hover:bg-fimi-turquoise/90 transition-colors flex items-center justify-center space-x-2 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {status === 'loading' ? (
                    <>
