#!/usr/bin/env python3
"""
Generate a single blog image using Google Gemini 3 Pro Image
"""
...
def main():
    # Image prompt
    prompt = "Eco-friendly cleaning products with green leaf accents, recycling symbol, and EU flag colors subtly integrated. Sustainable cleaning bottles, natural sponges on a light background. Environmental sustainability theme, no people, no hands, no faces. Clean corporate aesthetic."

    # Output path
    output_path = "/Users/brandea/Desktop/FIMI-Gebaeudereinigung/public/images/blog/eu-oekodesign-verordnung-espr-reinigung.png"
